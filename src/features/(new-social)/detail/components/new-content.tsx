  ...
  return (
    <div className="w-full flex flex-col gap-4">
      ...
      <p className="text-sm text-[#141416] font-medium">
        ...
        purus cum interdum ut platea vulputate quisque morbi mauris. Vivamus sed
        vestibulum pharetra cursus potenti neque ut. Sit non pulvinar non dolor.
        Non vestibulum felis adipiscing elementum morbi cursus. Vitae dignissim
        sit nullam amet. Proin pellentesque faucibus at sociis vitae dictum.
        Dignissim elit elit pretium ut etiam enim nunc eget. Molestie feugiat
        ridiculus proin pretium magnis. Senectus ultrices phasellus consectetur
        nunc tempor mi. Eget molestie tempor porta pulvinar consectetur nunc
        massa interdum. Urna donec ullamcorper interdum dictum molestie proin
        pharetra.
      </p>

      <div className="flex items-center gap-1 text-[#0077ED]">
        <span className="text-[#0077ED] text-sm font-medium">#Crypto</span>
        <span className="text-[#0077ED] text-sm font-medium">
          #CoinCapMarket
        </span>
      </div>

      {/* New Image */}
      <div className="size-full rounded-3xl max-h-[28.125rem] overflow-hidden">
        <Image
