...
import { OutlineButton } from "@/features/(new-social)/shared-components";
...
export const OwnerPost = () => {
  ...
  const text =
    "Lorem ipsum dolor sit amet consectetur. Vitae ac consectetur odio augue nunc integer condimentum gravida.";
  ...
  return (
    <div className="w-full flex flex-col gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col gap-0">
            <div className="flex items-center gap-2">
              ...
              <span className="text-neutral-400 text-sm">@CryptosRUs</span>
            </div>
            <span className="text-neutral-400 text-sm">Jan 01, 2025</span>
          </div>
        </div>
      ...
      {/* New paragraph */}
      <div className="text-sm text-[#141416]">
        {showMore ? text : `${text.slice(0, 60)}...`}
        <button
...
const EmojiButton = ({ children, icon }: EmojiButton) => {
  return (
    <div className="flex items-center gap-1 rounded-full py-1 px-3 bg-[#0077ED14]">
      {icon}
