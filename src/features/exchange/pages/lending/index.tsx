...
import TableLending from "./components/table";
import FillterLending from "./components/fillter";

const ExchangeLendingFeatures = () => {
  return (
...
export default ExchangeLendingFeatures;
